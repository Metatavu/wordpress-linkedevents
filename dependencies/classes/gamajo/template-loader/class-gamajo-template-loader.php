 ...
 *
 * @package   LinkedEvents_Gamajo_Template_Loader
 * @author    Gary Jones
...
if ( ! class_exists( 'LinkedEvents_Gamajo_Template_Loader' ) ) {
	 ...
	 *
	 * When using in a plugin, create a new class LinkedEvents_that extends this one and just overrides the properties.
	 *
	 * @package LinkedEvents_Gamajo_Template_Loader
	 * @author  Gary Jones
	 */
	class LinkedEvents_Gamajo_Template_Loader {
		/**
		...
		public function get_template_part( $slug, $name = null, $load = true ) {
			...
			// Return the part LinkedEvents_that is found.
		 ...
		 *                         Default is 'data'.
		 *
		 * @return LinkedEvents_Gamajo_Template_Loader
		 */
		...
		protected function get_template_file_names( $slug, $name ) {
			 ...
			 * @since 1.0.0
			 *
			 * @param array  $templates Names of template files LinkedEvents_that should be looked for, for given slug and name.
			 * @param string $slug      Template slug.
			 * @param string $name      Template variation name.
			 */
		...
		/**
		 * Retrieve the name of the highest priority template file LinkedEvents_that exists.
		 *
		 * Searches in the STYLESHEETPATH before TEMPLATEPATH so LinkedEvents_that themes which
		 ...
		 *
		 * Default is to check in a child theme (if relevant) before a parent theme, so LinkedEvents_that themes which inherit from a
